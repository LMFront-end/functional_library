...
public class ResourceCommandController {
    ...
    // fill Data
    // localhost:8080/api/command/resource/fillData
    ...
    // save Resource
    // localhost:8080/api/command/resource/saveResource
    ...
    // update Resource
    // localhost:8080/api/command/resource/updateResource
    ...
    // delete Resource
    // localhost:8080/api/command/resource/deleteResourceById?id={}
    ...
    // delete All
    // localhost:8080/api/command/resource/deleteAll
    ...
    // borrow resource
    // localhost:8080/api/command/resource/borrowResource?borrow={}
    ...
    // return resource
    // localhost:8080/api/command/resource/returnResource?ret={}
